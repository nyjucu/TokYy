...
class Checkpointer:
    ...
    def update( self, model, optimizer, epoch, scaler = None, scheduler = None, losses = {}, metrics = {}, learning_rate = 0 ):
        self.model = model
        self.optimizer = optimizer
    ...
    @staticmethod
    def get_epoch( path, map_loc = 'cuda' ):
        if not os.path.exists( path ):
    ...
    def show_learning_rates( self, only_last = True ):
